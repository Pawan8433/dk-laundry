...
const PATHS = {
  ...
  whatsapp: <><path d="M20 11.5a8 8 0 01-11.8 7L4 20l1.6-4.1A8 8 0 1120 11.5z" /><path d="M9 9.5c0 3 2.5 5.5 5.5 5.5.5 0 1-.6 1-1.2 0-.3-1.6-1-1.9-.8-.3.2-.6.8-.9.8-.8 0-2.3-1.5-2.3-2.3 0-.3.6-.6.8-.9.2-.3-.5-1.9-.8-1.9-.6 0-1.2.5-1.2 1z" /></>,
  star: <><path d="M12 3l2.6 5.6L20 9.3l-4 4 1 5.7-5-2.8-5 2.8 1-5.7-4-4 5.4-.7L12 3z" /></>,
};
